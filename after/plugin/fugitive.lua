...
vim.keymap.set({ "n", "v" }, "<leader>gf", "<cmd>Git fetch|echo '> git fetch'<cr><esc>")
vim.keymap.set({ "n", "v" }, "<leader>gF", "<cmd>Git pull|echo '> git pull'<cr><esc>")
vim.keymap.set({ "n", "v" }, "<leader>gp", "<cmd>Git push|echo '> git push'<cr><esc>")
vim.keymap.set({ "n", "v" }, "<leader>gP", "<cmd>Git push --force|echo '> git force push'<cr><esc>")
