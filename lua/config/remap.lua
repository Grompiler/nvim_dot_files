...
vim.keymap.set({ "n", "v" }, "<leader>bt", "<cmd>vsplit todo.md<cr>", { desc = "Buffer todo" })
-- Buffer mini plugin
vim.keymap.set({ "n", "v" }, "<leader>bb", "<cmd>Pick buffers<cr>", { desc = "Buffer todo" })
...
-- Errors Mini
vim.keymap.set('n', '<leader>el', "<cmd>Pick diagnostic<cr>", { desc = "Error Previous" })


-- File
vim.keymap.set({ "n", "v" }, "<leader>fs", "<cmd>wa<cr>", { desc = "File Save" })
-- File mini plugin
vim.keymap.set({ "n", "v" }, "<leader>ff", "<cmd>Pick files<cr>", { desc = "File Find" })
vim.keymap.set({ "n", "v" }, "<leader>fg", "<cmd>Pick files tool='git'<cr>", { desc = "File Git Find" })
vim.keymap.set({ "n", "v" }, "<leader>f.", "<cmd>lua MiniPick.start({ source = { items = vim.fn.readdir('.') } })<cr>", { desc = "File Find here" })
...
vim.keymap.set('n', '<leader>lq', "lsp restart", { desc = "LSP Format" })
...
vim.keymap.set("n", "<leader>qk", "<cmd>cclose<cr>")
